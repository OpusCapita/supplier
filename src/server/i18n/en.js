module.exports = {
  ...
  'notification.accessRejection.title': 'OpusCapita - User Access Regected',
  'notification.accessRejection.description': 'Unfortunately your access request to company <strong>{supplierName}</strong> has been rejected.'
};
