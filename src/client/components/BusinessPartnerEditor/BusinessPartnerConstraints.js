class BusinessPartnerConstraints {
  constructor(i18n) {
    this.i18n = i18n;
...
let allConstraints = function(i18n) {
  return {
    ...
    subEntityCode: {
      presence: false,
      subEntityCodeExists: {
        message: i18n.getMessage('BusinessPartnerValidatejs.duplicate.subEntityCode.message')
      }
    }
  };
};

export default BusinessPartnerConstraints;
